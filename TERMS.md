# BoiBot Terms of Service

Last Modified 29th November 2022.

These Terms of Service ("Terms"), are a legal agreement between BoiBot ("Us", "We" or "Our") and you ("you", "your", the "user", or the "end user"). By using or interacting with BoiBot Bot (the "Bot") which is referred to as the "Service", you ("User") agree to be bound by these Terms.
